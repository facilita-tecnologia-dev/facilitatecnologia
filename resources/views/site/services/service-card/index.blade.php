<div class="rounded-lg border-2 border-borders shadow-sm px-6 py-8 flex flex-col gap-4  bg-main-background hover:scale-[102%] transition {{ $active ? 'opacity-100' : 'opacity-60 pointer-events-none' }}">
    <header class="space-y-1">
        ...
        <h3 class="text-xl md:text-2xl text-main-text text-left font-semibold">{{ $name }}</h3>
    </header>
